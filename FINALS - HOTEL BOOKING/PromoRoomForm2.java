...
public class PromoRoomForm2 extends JFrame {
    private Font customFont;
    private JLabel hotelPhotoLabel; 

    public PromoRoomForm2() {
        loadCustomFont();
        setTitle("PROMO ROOM B DETAILS");
        setSize(700, 500);
        ...
        btnBookNow.addActionListener(e -> {
            if (RoomBookingManager.bookRoom("Promo Room B")) {
                String roomDetails = "Promo Room B";
                double price = 2500.0; 
                new ReservationForm(roomDetails, price).setVisible(true);
                dispose();
            } else {
                JOptionPane.showMessageDialog(PromoRoomForm2.this,
        ...
        btnNext.addActionListener(e -> {
            new PromoRoomForm3().setVisible(true);
            dispose();
        });
        ...
        JLabel lblTitle = new JLabel("PROMO ROOM B");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new PromoRoomForm2().setVisible(true));
    }
}
