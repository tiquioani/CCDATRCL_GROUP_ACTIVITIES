...
public class StandardRoomForm2 extends JFrame {
    private Font customFont;
    private JLabel hotelPhotoLabel; 

    public StandardRoomForm2() {
        loadCustomFont();
        setTitle("STANDARD ROOM B DETAILS");
        setSize(700, 500);
        ...
        btnNext.addActionListener(e -> {
            new StandardRoomForm3().setVisible(true);
            dispose();
        });
        ...
        btnBookNow.addActionListener(e -> {
            if (RoomBookingManager.bookRoom("Standard Room B")) {
                String roomDetails = "Standard Room B";
                double price = 5000.0;
                new ReservationForm(roomDetails, price).setVisible(true);
                dispose();
            } else {
                JOptionPane.showMessageDialog(StandardRoomForm2.this,
        ...
        JLabel lblTitle = new JLabel("STANDARD ROOM B");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new StandardRoomForm2().setVisible(true));
    }
}
